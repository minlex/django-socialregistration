...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facebook_facebookaccesstoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='access_token', unique=True, to=orm['facebook.FacebookProfile'])),
    ...
    models = {
        ...
        'facebook.facebookaccesstoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'access_token'", 'unique': 'True', 'to': "orm['facebook.FacebookProfile']"})
        },
