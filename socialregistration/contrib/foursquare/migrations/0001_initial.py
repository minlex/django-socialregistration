...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'foursquare_foursquareprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('foursquare', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'foursquare', ['FoursquareProfile'])

        # Adding model 'FoursquareAccessToken'
        db.create_table(u'foursquare_foursquareaccesstoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'foursquare', ['FoursquareAccessToken'])


    def backwards(self, orm):
        # Deleting model 'FoursquareProfile'
        db.delete_table(u'foursquare_foursquareprofile')

        # Deleting model 'FoursquareAccessToken'
        db.delete_table(u'foursquare_foursquareaccesstoken')
    ...
    models = {
        ...
        u'foursquare.foursquareaccesstoken': {
            'Meta': {'object_name': 'FoursquareAccessToken'},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'access_token'", 'unique': 'True', 'to': u"orm['foursquare.FoursquareProfile']"})
        },
        u'foursquare.foursquareprofile': {
